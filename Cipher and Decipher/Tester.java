...
public class Tester {
	...
	public static void main(String[] args) {
		...
		if (M1.equals(new Message ("ctgaqwiqkpivqigvvjghktuvqpg"))){
		...
		int[] key3 = {27,-5,4,25,32,-36,23};
		M3.vigenereCipher(key3);
		if (M3.equals(new Message("ivvckhkprknleouciuowbozvdiymizv"))){
		...
		M3 = new Message("ivvckhkprknleouciuowbozvdiymizv");
		...
		if (M4.equals(new Message ("ltnerstaodgti*scyohg*toooin*odudsm*neafae*earosn*", false))){
		...
		M4 = new Message("ltnerstaodgti*scyohg*toooin*odudsm*neafae*earosn*", false);
